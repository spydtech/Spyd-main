  ...
  return (
    ...
    <div className="flex flex-col md:flex-row items-center justify-between mt-10 p-6 md:px-20 bg-white rounded-lg">
      <div className="md:w-1/2 md:space-y-10">
        ...
        <button className="bg-gradient-to-r from-[#38bdf8] to-blue-700 text-sm md:text-lg text-white py-1 px-2 md:py-3 md:px-6 rounded hover:bg-blue-700 transition duration-300">
          Read More
        </button>
      </div>
    ...
    <div className="flex flex-col md:flex-row items-center justify-between md:mt-10 p-6 md:px-20 bg-white  ">
      <div className="md:w-1/2 mt-6 md:mt-0 flex justify-center">
        <img
      ...
      <div className="md:w-1/2 md:space-y-10 space-y-5">
        ...
        <button className="bg-gradient-to-r from-[#38bdf8] to-blue-700 text-sm md:text-lg py-1 px-2 text-white md:py-3 md:px-6 rounded hover:bg-blue-700 transition duration-300">
          Read More
        </button>
      </div>
    </div>
      ...
      <div className="max-w-9xl mx-auto md:px-20 px-6">
        ...
        <div className="flex flex-col md:flex-row-reverse items-center justify-between mt-10 md:mt-0  md:px-20  bg-white bg-opacity-95 bg-transparent  ">
          <div className="md:w-1/2 md:space-y-10 space-y-5">
            ...
            <button className="bg-gradient-to-r from-[#38bdf8] to-blue-700  text-white text-sm md:text-lg py-1  px-2 md:py-3 md:px-6 rounded hover:bg-blue-700 transition duration-300">
              Read More
            </button>
          </div>
          <div className="md:w-1/2 mt-6 md:mt-0 flex justify-center">
