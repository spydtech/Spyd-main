...
//               <div
//                 id={item.keyword}
//                 className="w-[300px] flex flex-col items-center justify-center bg-gradient-to-r from-[#00ceff] to-[#0072ff] h-[250px]"
//               >
//                 <img
//                   src={item.image}
        ...
        {data.map((item, index) => {
          return (
            <div
              ...
              className="relative mx-auto w-[360px] flex flex-col items-center justify-center bg-gradient-to-r from-[#00ceff] to-[#0072ff] h-[300px] overflow-hidden rounded-md shadow-md"
            >
              <img
                src={item.image}
