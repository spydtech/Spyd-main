...
const OurWorks = () => {
  return (
    <div className="bg-gradient-to-r from-blue-500 to-blue-300 py-10">
      <div className="max-w-5xl mx-auto text-center">
        {/* Title and Subtitle */}
        <div className="justify-center ml-[20%]">
        <div className="bg-blue-400 w-[600px]  rounded-full py-4 px-4 mb-8 mx-2 sm:mx-0">
          <h2 className="text-3xl font-bold text-blue-900">Our Works</h2>
