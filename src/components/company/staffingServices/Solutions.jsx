...
const Solutions = () => {
  ...
  return (
    <div className="my-5 flex flex-col items-center gap-3">
      <h1 
      data-aos="fade-down"
      className=" text-xl md:text-3xl bg-gradient-to-b from-[#00CEFF] to-[#0072FF] text-transparent bg-clip-text">
        Solutions That Funnel Results
      </h1>
      <p 
      data-aos="fade-down"
      className="text-center text-xs lg:text-base leading-5 mx-3">
