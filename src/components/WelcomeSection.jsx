  ...
  return (
    <div className="bg-white py-16 px-4 md:px-10 lg:px-20">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 md:gap-10">
        ...
        <div className="flex flex-col justify-center space-y-5 md:mt-5 mt-10">
          <h2 className="text-2xl md:text-4xl font-bold bg-gradient-to-r from-[#38bdf8] to-blue-700 bg-clip-text text-transparent md:mb-6">
            Welcome to SpY D Technology
          </h2>
          <p className="text-gray-700 md:text-xl text-sm   w-4/7">
